...
public final class Car {
    ...
    public Car(int year, String color, List<Wheel> wheels, Engine engine) {
        ...
        for (Wheel wheel : wheels) {
            wheelCopy.add(wheel == null ? null : wheel.clone());
        }
        this.wheels = Collections.unmodifiableList(wheelCopy);
    ...
    public List<Wheel> getWheels() {
        List<Wheel> outList = new ArrayList<>();
        for (Wheel wheel : wheels) {
            outList.add(wheel == null ? null : wheel.clone());
        }
        return outList;
    }
